...
if isvol.empty?
  puts "no ortogonal"
  `cp /Users/catalinabustamante/Documents/codigo/rubyfmri/design_tem_1.5.fsf #{dirniipath}/#{dn}/design_tem_1.5.fsf`
  else
    puts "ortogonal"
  `cp /Users/catalinabustamante/Documents/codigo/rubyfmri/design_tem_1.5_o.fsf #{dirniipath}/#{dn}/design_tem_1.5.fsf`
end
